...
Prototype.C_UINT SciterValueStringDataSet(*pval.SciterValue, chars.s, numChars.C_UINT, units.C_UINT)
...
Prototype.C_UINT SciterValueSetValueToKey(*pval.SciterValue, *pkey.SciterValue, *pval_to_set.SciterValue)
